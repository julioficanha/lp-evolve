    ...
    <section class="grafo-secao" id="abertura-servicos">
      <div class="u-wrap">
        <div class="grafo-secao__head">
          ...
          <h1 class="grafo-secao__titulo" data-escrever>Nossos serviços<br><em>partem de um mesmo núcleo.</em></h1>
        </div>
        ...
        <div class="grafo" data-grafo>
          ...
          <path class="grafo__link" data-link="3"></path>
            ...
            <g class="grafo__nos">
              <g class="grafo__no grafo__no--centro" data-no="centro"
...
<circle cx="9.2" cy="7.6" r="3.1"/>
                  <path d="M3.6 19.4c0-3.1 2.5-5.4 5.6-5.4s5.6 2.3 5.6 5.4"/>
          ...
          <a class="grafo__no" data-no="02" href="servicos-recrutamento-selecao.html"
            ...
            <svg class="grafo__no-icone" x="-14" y="-14" width="28" height="28" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
<circle cx="10.4" cy="6.6" r="2.7"/>
                  <path d="M5.6 15.2c0-2.5 2.1-4.5 4.8-4.5"/>
                  <circle cx="14.9" cy="14.9" r="4.4"/>
                  <path d="M18.2 18.2l3.1 3.1"/>
              </svg>
            <text class="grafo__no-rotulo" y="72">
              <tspan x="0" dy="0">Recrutamento</tspan>
              <tspan x="0" dy="1.22em">e Seleção</tspan>
            </text>
          </a>
          <a class="grafo__no" data-no="03" href="servicos-riscos-saude.html"
            ...
            <svg class="grafo__no-icone" x="-14" y="-14" width="28" height="28" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
<path d="M12 3.2l7 2.5v5.9c0 4.2-2.9 7.6-7 9.3-4.1-1.7-7-5.1-7-9.3V5.7l7-2.5z"/>
                  <path d="M7.9 12.2h2.2l1.2-2.5 1.5 4.1 1.1-1.6h2.2"/>
              </svg>
            <text class="grafo__no-rotulo" y="72">
              <tspan x="0" dy="0">Riscos Psicossociais</tspan>
              <tspan x="0" dy="1.22em">e Saúde</tspan>
            </text>
          </a>
...
<circle cx="12" cy="12" r="8.4"/>
          ...
          <p class="grafo__dica">Arraste os pontos · clique para abrir</p>
        </div>
    ...
    <section class="resultado">
      <div class="u-wrap">
        ...
        <p class="resultado__text" data-reveal>
          Transformamos negócios dependentes dos donos em empresas mais estruturadas, com segurança
          financeira e capazes de crescer com autonomia.
        </p>
    ...
    <section class="bloco" style="background:var(--off-white)">
      <div class="u-wrap">
        ...
        <div class="mag-grid" data-stagger="90">
          ...
          <article class="mag" data-reveal>
            <span class="mag__num">Frente 02</span>
            <h3 class="mag__title">Recrutamento e Seleção</h3>
            <p class="mag__desc">
              <strong>Pergunta que responde:</strong> como colocar as pessoas certas nos lugares certos?<br><br>
          ...
          <article class="mag" data-reveal>
            <span class="mag__num">Frente 03</span>
            <h3 class="mag__title">Riscos Psicossociais e Saúde Organizacional</h3>
            <p class="mag__desc">
              <strong>Pergunta que responde:</strong> como reconhecer e controlar fatores do trabalho que afetam saúde e desempenho?<br><br>
    ...
    <!-- REGRA COMERCIAL -->
    <section class="ordem" style="padding:clamp(4rem,8vw,6.5rem) 0">
      <canvas class="ordem__canvas" aria-hidden="true"></canvas>
      ...
      <div class="u-wrap">
        <div class="indicadores">
          ...
          <div class="indicador" data-reveal style="--d:90ms">
            <span class="indicador__num"><span class="value">4</span><span class="suffix">fases</span></span>
            <span class="indicador__label">Diagnóstico · Plano 5W2H · Implantação acompanhada · Transferência de método.</span>
          </div>
